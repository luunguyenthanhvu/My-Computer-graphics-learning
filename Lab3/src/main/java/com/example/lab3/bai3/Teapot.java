...
public class Teapot extends GLJPanel implements GLEventListener {
  ...
  public void drawTeapot(GL2 gl) {
    gl.glColor3f(0.8f, 0.5f, 0.2f); // Màu nâu cho ấm trà

    // Thân ấm trà
    gl.glPushMatrix();
    gl.glTranslatef(0.0f, -0.5f, 0.0f);
    glut = new GLUT();
    glut.glutSolidTeapot(1.0); // Vẽ ấm trà
    gl.glPopMatrix();
    ...
    glut.glutSolidSphere(0.5, 20, 20); // Vẽ nắp ấm trà
    gl.glPopMatrix();
    ...
    glut.glutSolidSphere(0.5, 20, 20); // Vẽ vòi
    gl.glPopMatrix();
  }
